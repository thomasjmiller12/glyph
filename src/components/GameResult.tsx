        ...
        {show && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-sm rounded-xl border border-[#2A2A2E] bg-[#141416] p-6 text-center"
            >
              <button
                onClick={onClose}
                className="absolute right-3 top-3 text-[#8B8B8B] hover:text-[#E8E8E8]"
              >
                <X size={20} />
              </button>
              ...
              <div className="flex justify-center gap-3">
                <Link
                  href="/"
                  className="rounded-lg border border-[#2A2A2E] px-4 py-2 text-sm text-[#8B8B8B] transition-colors hover:border-[#D4A574] hover:text-[#E8E8E8]"
                >
                  New Challenge
                </Link>
              </div>
